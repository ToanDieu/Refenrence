...
export default class Toolbar extends React.Component {
  ...
  componentWillMount() {
    ...
    document.addEventListener("mousedown", this.clickOutsideHandle, false);
  }

  componentWillUnmount() {
    this.props.store.unsubscribeFromItem("selection", this.onSelectionChanged);
    document.removeEventListener("mousedown", this.clickOutsideHandle, false);
  }
  ...
  onSelectionChanged = () => {
    ...
    setTimeout(() => {
      ...
      if (!selectionRect || this.state.inside) return;
  ...
  render() {
    ...
    return (
      <div className="toolbar" style={this.getStyle()} ref={this.handleToolbarRef}>
        {OverrideContent ? (
